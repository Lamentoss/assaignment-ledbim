...
/// @nodoc
@JsonSerializable()
class _$_LoginResponse with IResponse implements _LoginResponse {
  _$_LoginResponse({this.token, this.error});
...
abstract class _LoginResponse implements LoginResponse, IResponse {
  factory _LoginResponse({final String? token, final String? error}) =
      _$_LoginResponse;
